...
exports.readData = function readData(b, type, flags, major) {
  ...
  switch (type) {
    ...
    case 'COM': case 'COMM':
      ...
      comment.language = b.toString('utf8', offset, offset + 3);
      offset += 3;
      
      var zeroOff = findZero(b, offset, length, encoding);
      comment.short_description = decodeString(b, encoding, offset, zeroOff);
      offset = zeroOff + 1;
