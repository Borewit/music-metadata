...
export default class GUID {
  ...
  public static SimpleIndexObject = new GUID(
    "33000890-E5B1-11CF-89F4-00A0C90349CB"
  );
  public static IndexObject = new GUID("D6E229D3-35DA-11D1-9034-00A0C90349BE");
  public static MediaObjectIndexObject = new GUID(
    "FEB103F8-12AD-4C64-840F-2A1D2F7AD48C"
  );
  public static TimecodeIndexObject = new GUID(
    "3CB73FD0-0C4A-4803-953D-EDF7B6228F0C"
  );

  // 10.2 Header Object GUIDs
  public static FilePropertiesObject = new GUID(
    "8CABDCA1-A947-11CF-8EE4-00C00C205365"
  );
  public static StreamPropertiesObject = new GUID(
    "B7DC0791-A9B7-11CF-8EE6-00C00C205365"
  );
  public static HeaderExtensionObject = new GUID(
    "5FBF03B5-A92E-11CF-8EE3-00C00C205365"
  );
  public static CodecListObject = new GUID(
    "86D15240-311D-11D0-A3A4-00A0C90348F6"
  );
  public static ScriptCommandObject = new GUID(
    "1EFB1A30-0B62-11D0-A39B-00A0C90348F6"
  );
  public static MarkerObject = new GUID("F487CD01-A951-11CF-8EE6-00C00C205365");
  public static BitrateMutualExclusionObject = new GUID(
    "D6E229DC-35DA-11D1-9034-00A0C90349BE"
  );
  public static ErrorCorrectionObject = new GUID(
    "75B22635-668E-11CF-A6D9-00AA0062CE6C"
  );
  public static ContentDescriptionObject = new GUID(
    "75B22633-668E-11CF-A6D9-00AA0062CE6C"
  );
  public static ExtendedContentDescriptionObject = new GUID(
    "D2D0A440-E307-11D2-97F0-00A0C95EA850"
  );
  public static ContentBrandingObject = new GUID(
    "2211B3FA-BD23-11D2-B4B7-00A0C955FC6E"
  );
  public static StreamBitratePropertiesObject = new GUID(
    "7BF875CE-468D-11D1-8D82-006097C9A2B2"
  );
  public static ContentEncryptionObject = new GUID(
    "2211B3FB-BD23-11D2-B4B7-00A0C955FC6E"
  );
  public static ExtendedContentEncryptionObject = new GUID(
    "298AE614-2622-4C17-B935-DAE07EE9289C"
  );
  public static DigitalSignatureObject = new GUID(
    "2211B3FC-BD23-11D2-B4B7-00A0C955FC6E"
  );
  public static PaddingObject = new GUID(
    "1806D474-CADF-4509-A4BA-9AABCB96AAE8"
  );

  // 10.3 Header Extension Object GUIDs
  public static ExtendedStreamPropertiesObject = new GUID(
    "14E6A5CB-C672-4332-8399-A96952065B5A"
  );
  public static AdvancedMutualExclusionObject = new GUID(
    "A08649CF-4775-4670-8A16-6E35357566CD"
  );
  public static GroupMutualExclusionObject = new GUID(
    "D1465A40-5A79-4338-B71B-E36B8FD6C249"
  );
  public static StreamPrioritizationObject = new GUID(
    "D4FED15B-88D3-454F-81F0-ED5C45999E24"
  );
  public static BandwidthSharingObject = new GUID(
    "A69609E6-517B-11D2-B6AF-00C04FD908E9"
  );
  public static LanguageListObject = new GUID(
    "7C4346A9-EFE0-4BFC-B229-393EDE415C85"
  );
  public static MetadataObject = new GUID(
    "C5F8CBEA-5BAF-4877-8467-AA8C44FA4CCA"
  );
  public static MetadataLibraryObject = new GUID(
    "44231C94-9498-49D1-A141-1D134E457054"
  );
  public static IndexParametersObject = new GUID(
    "D6E229DF-35DA-11D1-9034-00A0C90349BE"
  );
  public static MediaObjectIndexParametersObject = new GUID(
    "6B203BAD-3F11-48E4-ACA8-D7613DE2CFA7"
  );
  public static TimecodeIndexParametersObject = new GUID(
    "F55E496D-9797-4B5D-8C8B-604DFE9BFB24"
  );
  public static CompatibilityObject = new GUID(
    "26F18B5D-4584-47EC-9F5F-0E651F0452C9"
  );
  public static AdvancedContentEncryptionObject = new GUID(
