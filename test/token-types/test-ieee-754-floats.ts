  ...
  describe("32-bit (single precision)", () => {
    describe("big-endian", () => {
      it("should encode", () => {
        ...
        Token.Float32_BE.put(buffer, 0, 0);
