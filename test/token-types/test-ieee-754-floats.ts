...
describe("80-bit (extended precision)", () => {
  describe("big-endian", () => {
    ...
    test("should decode", () => {
      const buf = Buffer.from([0x40, 0x02, 0xaa, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
  ...
  describe("little-endian", () => {
    ...
    test.skip("should decode", () => {
      const buf = Buffer.from([0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0xaa, 0x02, 0x40]);
