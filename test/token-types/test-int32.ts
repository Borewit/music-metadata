...
describe("Parse 32-bit signed integer", () => {
  describe("big-endian", () => {
    it("should encode", () => {
      ...
      Token.INT32_BE.put(buf, 0, 0x0f_0b_cc_a0);
    ...
    it("should decode", () => {
      ...
      assert.equal(Token.INT32_BE.get(buf, 0), 1_048_831);
      assert.equal(Token.INT32_BE.get(buf, 4), -2_147_483_648);
    });
  });
  ...
  describe("little-endian", () => {
    it("should encode", () => {
      ...
      Token.INT32_LE.put(buf, 0, 0x0f_0b_cc_a0);
    ...
    it("should decode", () => {
      ...
      assert.equal(Token.INT32_LE.get(buf, 0), 1_048_831);
      assert.equal(Token.INT32_LE.get(buf, 4), -2_147_483_648);
    });
  });
});
