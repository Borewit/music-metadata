...
var t = chai_1.assert;
it("should decode id3v2.2", function () {
    var filename = 'id3v2.2.mp3';
    ...
    return mm.parseFile(filePath, { duration: true }).then(function (result) {
        ...
        var native = result.native['id3v2.2'];
        ...
        t.deepEqual(native[i++], { id: 'COM', value: { description: 'iTunPGAP', language: 'eng', text: '0' } }, "['id3v2.2'].COM");
        t.deepEqual(native[i++], { id: 'TEN', value: 'iTunes v7.0.2.16' }, "['id3v2.2'].TEN");
        t.deepEqual(native[i++], { id: 'COM', value: { description: 'iTunNORM', language: 'eng', text: ' 0000299C 0000291D 0000DBE0 0000D6BA 0003C378 0003C2C1 0000902A 00008F1B 00012FC6 00015FBC' } }, "['id3v2.2'].COM");
        t.deepEqual(native[i++], { id: 'COM', value: { description: 'iTunSMPB', language: 'eng', text: ' 00000000 00000210 00000AD4 0000000000B6499C 00000000 006327AD 00000000 00000000 00000000 00000000 00000000 00000000' } }, "['id3v2.2'].COM");
        t.deepEqual(native[i++], { id: 'COM', value: { description: 'iTunes_CDDB_IDs', language: 'eng', text: '11+3ABC77F16B8A2F0F1E1A1EBAB868A98F+8210091' } }, "['id3v2.2'].COM");
        {
            var picTag = native[i++];
