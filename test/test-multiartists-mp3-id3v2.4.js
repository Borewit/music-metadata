...
test('Test multi-artists flac', function (t) {
  ...
  function checkID3Tags (id3v24) {
    ...
    t.deepEqual(id3v24.TIPL, {
      arranger: [ 'Jeff Bova' ],
      engineer: [ 'James McCullagh', 'Jared Kvitka' ],
      producer: [ 'Roy Weisman' ] }, 'event id3v24.TIPL');

    t.deepEqual(id3v24.TIT2, 'Sinner\'s Prayer', 'id3v24.TIT2: Title/songname/content description')

    t.deepEqual(id3v24.TMCL, {
      ...
      piano: [ 'Beth Hart' ],
      vocals: [ 'Beth Hart', 'Joe Bonamassa' ] }, 'event id3v24.TMCL');
