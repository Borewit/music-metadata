...
describe("Parsing of metadata saved by 'Picard' in audio files", () => {
  ...
  describe("ID3v2.4 header", () => {
    function checkID3Tags(id3v24: INativeTagDict) {
      ...
      t.deepEqual(
        id3v24.APIC[0].description,
        "",
        "id3v24.APIC.data.description"
      );
      t.deepEqual(
