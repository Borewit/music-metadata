...
describe('ID3v2Parser', () => {
  ...
  it('should normalize ID3v2.2 comments correctly', async () => {
    ...
    assert.deepEqual(id3v22['COM:iTunPGAP'], ['0'], '[\'ID3v2.2\'][\'COM:iTunPGAP\']');
    assert.deepEqual(id3v22.TEN, ['iTunes 10.2.2.14'], '[\'ID3v2.2\'].TEN');
    assert.deepEqual(id3v22['COM:iTunNORM'], [' 00000308 00000000 00001627 00000000 00006FD6 00000000 00007F21 00000000 0000BE68 00000000'], 'COM:iTunNORM');
    assert.deepEqual(id3v22['COM:iTunSMPB'], [' 00000000 00000210 00000811 000000000043E1DF 00000000 001EBD63 00000000 00000000 00000000 00000000 00000000 00000000'], 'id3v22.TYE[\'COM:iTunSMPB\']');
    ...
    assert.deepEqual(id3v22.COM, ['UBI025, 23.05.2011, http://ubiktune.org/releases/ubi025-rushjet1-forgotten-music'], '[\'ID3v2.2\'][\'COM\']');

    assert.deepEqual(metadata.common.comment, ['UBI025, 23.05.2011, http://ubiktune.org/releases/ubi025-rushjet1-forgotten-music'], 'common.comment');
  });
  ...
  it('should decode file \'id3v2.2.mp3\'', async () => {
    ...
    assert.deepEqual(id3v22['COM:iTunNORM'], [' 0000299C 0000291D 0000DBE0 0000D6BA 0003C378 0003C2C1 0000902A 00008F1B 00012FC6 00015FBC'], 'COM:iTunNORM');

    assert.deepEqual(id3v22['COM:iTunSMPB'], [' 00000000 00000210 00000AD4 0000000000B6499C 00000000 006327AD 00000000 00000000 00000000 00000000 00000000 00000000'], 'id3v22.TYE[\'COM:iTunSMPB\']');
