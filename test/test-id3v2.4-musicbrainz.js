...
var t = chai_1.assert;
it("should MusicBrainz tags with id3v2.4", function () {
    ...
    return mm.parseFile(filePath, { duration: true }).then(function (result) {
        ...
        t.deepEqual(native[i++], { id: 'PRIV', value: { data: new Buffer([0x02, 0x00, 0x00, 0x00]), owner_identifier: 'AverageLevel' } }, "['id3v2.4'].PRIV.AverageLevel");
        t.deepEqual(native[i++], { id: 'PRIV', value: { data: new Buffer([0x08, 0x00, 0x00, 0x00]), owner_identifier: 'PeakValue' } }, "['id3v2.4'].PRIV.PeakValue");
